...
- periodic_calculate_ion_tensor ... boolean, calculate and return the periodic ion diffusion tensor; default true. Set false for field/current/diagnostic-only runs; `D_ion` remains unavailable
