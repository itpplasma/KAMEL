module electrostatic_kernel_adaptive_mod
    ...
    subroutine FP_calc_kernels_adaptive(l, lp, k_rho_phi, k_rho_B, k_j_phi, k_j_B, gauss_conf, rkf45_conf)

        use KIM_kinds, only: dp
        use electrostatic_integrals_gauss_mod, only: gauss_integrate_F0, gauss_config_t
        use electrostatic_integrals_rkf45_mod, only: rkf45_integrate_F1, rkf45_integrate_F2, rkf45_integrate_F3, rkf45_config_t
        use species, only: plasma
        use constants, only: pi
        ...
        use electrostatic_integrands_rkf45_mod, only: rkf45_int_F1_rho_phi_t, &
            rkf45_int_F2_rho_phi_t, rkf45_int_F3_rho_phi_t, integration_point_t
        ...
        type(integration_point_t) :: int_point
        type(gauss_int_F0_rho_phi_t) :: int_F0
        type(rkf45_int_F1_rho_phi_t) :: int_F1
        type(rkf45_int_F2_rho_phi_t) :: int_F2
        type(rkf45_int_F3_rho_phi_t) :: int_F3
        ...
        do sigma = 0, plasma%n_species - 1
            ...
            do j = 2, size(plasma%r_grid)-1
                ...
                call rkf45_integrate_F1(int_F1, integral_val, rkf45_conf)
                ...
                call rkf45_integrate_F2(int_F2, integral_val, rkf45_conf)
                ...
                call rkf45_integrate_F3(int_F3, integral_val, rkf45_conf)
