subroutine kim_read_config
    ...
    ! that omit it get fresh defaults instead of inheriting a preceding handle.
    ...
    periodic_Bparallel_drive = (0.0_dp, 0.0_dp)
...
contains
    ...
    pure function ascii_upper(text) result(upper)
