module integrals_rkf45_m
    ...
    subroutine rkf45_integrate_F0(result, rkf45_conf, context)
        ...
        use integrands_rkf45_m, only: rkf45_integrand_context_t, rkf45_integrand_F0
    ...
    subroutine rkf45_integrate_F1(result, rkf45_conf, context)
        ...
        use integrands_rkf45_m, only: rkf45_integrand_context_t, rkf45_integrand_F1
        use constants_m, only: pi
    ...
    subroutine rkf45_integrate_F2(result, rkf45_conf, context)
        ...
        use constants_m, only: pi
        use RKF45_mod, only: RKF45_1D_with_context
        use integrands_rkf45_m, only: rkf45_integrand_context_t, rkf45_integrand_F2
        use grid_m, only: rkf45_atol, rkf45_rtol
    ...
    subroutine rkf45_integrate_F3(result, rkf45_conf, context)
        ...
        use constants_m, only: pi
        use RKF45_mod, only: RKF45_1D_with_context
        use integrands_rkf45_m, only: rkf45_integrand_context_t, rkf45_integrand_F3
        use grid_m, only: rkf45_atol, rkf45_rtol
