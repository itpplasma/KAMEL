      SUBROUTINE ZGEEVT( JOBVL, JOBVR, N, A, LDA, W, VL, LDVL, VR, LDVR,
     $                        WORK, LWORK, RWORK, INFO )

* Ivan Ivanov: the modified code makes the first component of eigenvectors real
*(not largest as in original version) - see changes at the end of the code
*
...
*
     ...
     $                               DIMAG( VL( K, I ) )**2
   10       CONTINUE
*           here we use the first component instead the largest:
