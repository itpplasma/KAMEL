...
if(NOT DEFINED HDF5_DIR)
    ...
    if(_hdf5_config_file)
        ...
        if(_parallel_pos GREATER -1)
            # System HDF5 requires MPI — check if MPI is available before skipping
            find_package(MPI QUIET COMPONENTS C Fortran)
            if(MPI_FOUND)
                message(STATUS "System HDF5 requires MPI (parallel) — MPI found, proceeding")
            else()
                message(STATUS "System HDF5 requires MPI (parallel) but MPI not found — skipping, will build from source")
