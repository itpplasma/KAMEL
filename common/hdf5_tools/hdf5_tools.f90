module KAMEL_hdf5_tools
  ...
  interface h5_add
     ...
     module procedure h5_add_float_1
  ...
  interface h5_append
     ...
     module procedure h5_append_double_1
...
contains
 ...
 subroutine h5_append_double_0(dsetid, value, offset)
  ...
  !**********************************************************
  ! Append double array to unlimited dimension
  ! Added by Markus Markl, 23.02.2021
  !**********************************************************
...
!!$  end subroutine h5_get_int8_2
  ...
  subroutine h5_add_float_1(h5id, dataset, value, lbounds, ubounds, comment, unit)
    ...
    dims = ubounds - lbounds + 1
    size = rank
    call h5ltmake_dataset_float_f(h5id, dataset, rank, dims, value, h5error)
    call h5ltset_attribute_int_f(h5id, dataset, 'lbounds', lbounds, size, h5error)
    call h5ltset_attribute_int_f(h5id, dataset, 'ubounds', ubounds, size, h5error)
