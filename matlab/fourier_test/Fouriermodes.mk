...
OBJS/field_eq_mod.o: field_eq_mod.f90 Fouriermodes.mk
	$(FC) $(OPTS) -c field_eq_mod.f90
	mv field_eq_mod.o OBJS/
OBJS/field_divB0.o: field_divB0.f90 Fouriermodes.mk
	$(FC) $(OPTS) -c field_divB0.f90 OBJS/field_eq_mod.o
