...
class fieldpy:
    ...
    def __init__(self, gfile, pfile, convex_file, fluxdata_path):
        ...
        self.field_divB0_inp["pfile"] = (
            ""  # field.dat - coil file (field.dat) from Kisslinger_asdex or coil_tools
        )
    ...
    def write_field_divB0_inp(self, path_from, path_to):
        ...
        self.changed = change_opts_fieldpy(
            self.existing,
            self.ind,
            [
                self.field_divB0_inp["gfile"],
                self.field_divB0_inp["pfile"],
                self.field_divB0_inp["convexfile"],
                self.field_divB0_inp["fluxdatapath"],
            ],
            " ",
        )
    ...
    def run_fourier_modes(self):
        ...
        try:
            ...
            os.system(
                "ln -sf " + self.path_to_fourier_modes_exe + "fouriermodes.x ./fouriermodes.x"
            )
