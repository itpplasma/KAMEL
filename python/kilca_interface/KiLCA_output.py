...
class KiLCA_output(InpOut):
    ...
    Variables:
        ...
        flag_deb
        curdenspet, abspow, dispow, kinfluxr, poyntfluxr, totfluxr,numdenspet, lortorq
        ind, BLUEPRINT
    Methods:
        KiLCA_output()
        data()
    ...
    def data(self):
        return [self.backdata, self.lindata, self.varquant, self.disp, self.flag_deb, self.curdenspet, self.abspow, self.dispow, self.kinfluxr, self.poyntfluxr, self.totfluxr, self.numdenspet, self.lortorq]