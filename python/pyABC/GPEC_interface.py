...
class GPEC_interface:
    ...
    template_input = (
        os.path.abspath(
            os.path.join(lib_GPEC_interface, "../matlab/balance/GPEC_interface/template/")
        )
        + "/"
    )
    ...
    def run_code(self, code):
        ...
        # execute code
        self.out_code = subprocess.Popen(
            "".join(self.getConf()) + " ; ./" + code,
            shell=True,
