...
class field_divB0(InpOut):
    ...
    def data(self):
        return [self.ipert, self.iequil, self.ampl, self.ntor, self.cutoff, \
            self.icftype, self.gfile, self.pfile, self.convexfile, \
                self.fluxdatapath, self.winsize_Rfilt, self.winsize_Zfilt]
