...
studyname = 'timeevol_faster_ramp_up'; % specifies the directory, should describe the intent
...
balancenml.BALANCENML.faster_ramp_up = 1; % ramp up faster
balancenml.BALANCENML.t_max_ramp_up = 1e-2; % time when expt. value of ramp up is reached in sec

balancenml.BALANCENML.temperature_limit = 10;
balancenml.BALANCENML.antenna_max_stopping = 2.0;
