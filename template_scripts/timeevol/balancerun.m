...
studyname = 'timeevol'; % specifies the directory, should describe the intent
...
balancenml.BALANCENML.write_formfactors = true;
balancenml.BALANCENML.debug_mode = true;
balancenml.BALANCENML.timing_mode = true; % saves time needed for certain computations
